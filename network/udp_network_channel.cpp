...
UdpNetworkChannel::UdpNetworkChannel(const std::string& channel_name, const std::string& ip_address, short int port): BroadcastChannel(channel_name)
{
